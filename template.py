...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rowCheckBox = QtWidgets.QCheckBox(self.centralwidget)
        self.rowCheckBox.setObjectName("rowCheckBox")
        self.gridLayout.addWidget(self.rowCheckBox, 1, 4, 1, 1)
        self.columnCheckbox = QtWidgets.QCheckBox(self.centralwidget)
        self.columnCheckbox.setObjectName("columnCheckbox")
        self.gridLayout.addWidget(self.columnCheckbox, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.dataTable, 3, 6, 1, 1)
        self.contentOnlyLabel = QtWidgets.QLabel(self.centralwidget)
        self.contentOnlyLabel.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.contentOnlyLabel.setObjectName("contentOnlyLabel")
        self.gridLayout.addWidget(self.contentOnlyLabel, 0, 4, 1, 1)
        self.chooseFileButton = QtWidgets.QPushButton(self.centralwidget)
        self.chooseFileButton.setObjectName("chooseFileButton")
        self.gridLayout.addWidget(self.chooseFileButton, 4, 4, 1, 1)
        self.fileNameLabel = QtWidgets.QLabel(self.centralwidget)
        self.fileNameLabel.setObjectName("fileNameLabel")
        self.gridLayout.addWidget(self.fileNameLabel, 2, 6, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rowCheckBox.setText(_translate("MainWindow", "Row"))
        self.columnCheckbox.setText(_translate("MainWindow", "Column"))
        ...
        self.contentOnlyLabel.setText(_translate("MainWindow", "Content only"))
